 ...
 *
 * <p>This class provides reusable timing patterns commonly needed in automation scripts,
 * such as polling until conditions are met, repeating actions with timeouts, and
 * handling dynamic wait intervals.</p>
 */
public class TimingUtils {
     ...
     *
     * <p>This is the core polling loop implementation used throughout the fluent API.
     * It supports dynamic polling rates and proper timeout handling.</p>
     *
     * <h3>Execution Flow</h3>
     * <ol>
     *   <li>Check exit condition (early return if already met)</li>
     *   <li>Execute the action</li>
     *   <li>Check exit condition again (in case action changed state)</li>
     *   <li>Wait for the polling interval</li>
     *   <li>Repeat until condition is met or timeout</li>
     * </ol>
     *
     ...
     */
    public static boolean repeatUntil(Supplier<Boolean> action, BooleanSupplier exitCondition,
     ...
     *
     * <p>This is useful for waiting for game state changes without repeatedly executing actions.</p>
     *
     ...
     */
    public static boolean waitUntil(BooleanSupplier condition, LongSupplier pollingRateSupplier, long timeoutMs) {
     ...
     *
     * <p>Starts with an initial delay and doubles it each iteration up to a maximum value.</p>
     *
     ...
     *
     * <p>Returns the base delay plus a random amount up to the jitter value.</p>
     *
